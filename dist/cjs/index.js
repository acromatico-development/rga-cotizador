var $IXXJW$nodefs = require("node:fs");
var $IXXJW$nodepath = require("node:path");
var $IXXJW$nodehttp = require("node:http");
var $IXXJW$nodehttps = require("node:https");
var $IXXJW$nodezlib = require("node:zlib");
var $IXXJW$nodestream = require("node:stream");
var $IXXJW$nodebuffer = require("node:buffer");
var $IXXJW$nodeutil = require("node:util");
var $IXXJW$nodeurl = require("node:url");
var $IXXJW$nodenet = require("node:net");
...
parcelRequire.register("dbXe9", function(module, exports) {
/**
...
parcelRequire.register("4ladG", function(module, exports) {

$parcel$export(module.exports, "FormData", () => $32910d074193412e$export$3963aa24c930693c);
$parcel$export(module.exports, "formDataToBlob", () => $32910d074193412e$export$a38b1dc2b31ef62a);
/*! formdata-polyfill. MIT License. Jimmy Wärting <https://jimmy.warting.se/opensource> */ 
var $dKr8m = parcelRequire("dKr8m");

var $d56GY = parcelRequire("d56GY");
var { toStringTag: $32910d074193412e$var$t , iterator: $32910d074193412e$var$i , hasInstance: $32910d074193412e$var$h  } = Symbol, $32910d074193412e$var$r = Math.random, $32910d074193412e$var$m = "append,set,get,getAll,delete,keys,values,entries,forEach,constructor".split(","), $32910d074193412e$var$f = (a, b, c)=>(a += "", /^(Blob|File)$/.test(b && b[$32910d074193412e$var$t]) ? [
        (c = c !== void 0 ? c + "" : b[$32910d074193412e$var$t] == "File" ? b.name : "blob", a),
        b.name !== c || b[$32910d074193412e$var$t] == "blob" ? new (0, $d56GY.default)([
            b
        ], c, b) : b
    ] : [
        a,
        b + ""
    ]), $32910d074193412e$var$e = (c, f)=>(f ? c : c.replace(/\r?\n|\r/g, "\r\n")).replace(/\n/g, "%0A").replace(/\r/g, "%0D").replace(/"/g, "%22"), $32910d074193412e$var$x = (n, a, e)=>{
    if (a.length < e) throw new TypeError(`Failed to execute '${n}' on 'FormData': ${e} arguments required, but only ${a.length} present.`);
};
const $32910d074193412e$export$b6afa8811b7e644e = (0, $d56GY.default);
const $32910d074193412e$export$3963aa24c930693c = class FormData {
    #d = [];
    constructor(...a){
        if (a.length) throw new TypeError(`Failed to construct 'FormData': parameter 1 is not of type 'HTMLFormElement'.`);
    }
    get [$32910d074193412e$var$t]() {
        return "FormData";
    }
    [$32910d074193412e$var$i]() {
        return this.entries();
    }
    static [$32910d074193412e$var$h](o) {
        return o && typeof o === "object" && o[$32910d074193412e$var$t] === "FormData" && !$32910d074193412e$var$m.some((m)=>typeof o[m] != "function");
    }
    append(...a) {
        $32910d074193412e$var$x("append", arguments, 2);
        this.#d.push($32910d074193412e$var$f(...a));
    }
    delete(a) {
        $32910d074193412e$var$x("delete", arguments, 1);
        a += "";
        this.#d = this.#d.filter(([b])=>b !== a);
    }
    get(a) {
        $32910d074193412e$var$x("get", arguments, 1);
        a += "";
        for(var b = this.#d, l = b.length, c = 0; c < l; c++)if (b[c][0] === a) return b[c][1];
        return null;
    }
    getAll(a, b) {
        $32910d074193412e$var$x("getAll", arguments, 1);
        b = [];
        a += "";
    ...
    has(a) {
        $32910d074193412e$var$x("has", arguments, 1);
        a += "";
        return this.#d.some((b)=>b[0] === a);
    }
    forEach(a, b) {
        $32910d074193412e$var$x("forEach", arguments, 1);
        for (var [c, d] of this)a.call(b, d, c, this);
    }
    set(...a) {
        $32910d074193412e$var$x("set", arguments, 2);
        var b = [], c = !0;
        a = $32910d074193412e$var$f(...a);
        this.#d.forEach((d)=>{
...
function $32910d074193412e$export$a38b1dc2b31ef62a(F, B = (0, $dKr8m.default)) {
    var b = `${$32910d074193412e$var$r()}${$32910d074193412e$var$r()}`.replace(/\./g, "").slice(-28).padStart(32, "-"), c = [], p = `--${b}\r\nContent-Disposition: form-data; name="`;
    F.forEach((v, n)=>typeof v == "string" ? c.push(p + $32910d074193412e$var$e(n) + `"\r\n\r\n${v.replace(/\r(?!\n)|(?<!\r)\n/g, "\r\n")}\r\n`) : c.push(p + $32910d074193412e$var$e(n) + `"; filename="${$32910d074193412e$var$e(v.name, 1)}"\r\nContent-Type: ${v.type || "application/octet-stream"}\r\n\r\n`, v, "\r\n"));
    c.push(`--${b}--`);
    return new B(c, {
...
parcelRequire.register("dKr8m", function(module, exports) {

$parcel$export(module.exports, "default", () => $a0249e6f8eec0966$export$2e2bcd8739ae039);
...
const $a0249e6f8eec0966$var$POOL_SIZE = 65536;
/** @param {(Blob | Uint8Array)[]} parts */ async function* $a0249e6f8eec0966$var$toIterator(parts, clone = true) {
    for (const part of parts){
        if ("stream" in part) yield* /** @type {AsyncIterableIterator<Uint8Array>} */ part.stream();
            ...
            if (clone) {
                ...
                while(position !== end){
                    const size = Math.min(end - position, $a0249e6f8eec0966$var$POOL_SIZE);
            ...
            while(position !== b.size){
                const chunk = b.slice(position, Math.min(b.size, position + $a0249e6f8eec0966$var$POOL_SIZE));
...
const $a0249e6f8eec0966$var$_Blob = class Blob {
   ...
   */ async text() {
        ...
        let str = "";
        for await (const part of $a0249e6f8eec0966$var$toIterator(this.#parts, false))str += decoder.decode(part, {
            stream: true
        });
        // Remaining
        str += decoder.decode();
   ...
   */ async arrayBuffer() {
        ...
        let offset = 0;
        for await (const chunk of $a0249e6f8eec0966$var$toIterator(this.#parts, false)){
    ...
    stream() {
        const it = $a0249e6f8eec0966$var$toIterator(this.#parts, true);
...
Object.defineProperties($a0249e6f8eec0966$var$_Blob.prototype, {
    size: {
        enumerable: true
    },
    type: {
...
const $a0249e6f8eec0966$export$3b660928c86ff55c = $a0249e6f8eec0966$var$_Blob;
var $a0249e6f8eec0966$export$2e2bcd8739ae039 = $a0249e6f8eec0966$export$3b660928c86ff55c;

});
parcelRequire.register("khxAZ", function(module, exports) {
/* c8 ignore start */ // 64 KiB (same size chrome slice theirs blob into Uint8array's)
const $8477fd97a532e712$var$POOL_SIZE = 65536;
...
try {
    const process = $8477fd97a532e712$import$a0113067e94a2394;
    const { emitWarning: emitWarning  } = process;
    try {
        process.emitWarning = ()=>{};
        Object.assign(globalThis, $8477fd97a532e712$import$69cf9fb4cb860a04);
    ...
    Object.assign(globalThis, (parcelRequire("dbXe9")));
}

try {
    // Don't use node: prefix for this, require+node: is not supported until node v14.14
    // Only `import()` can use prefix in 12.20 and later
    const { Blob: Blob  } = $8477fd97a532e712$import$16b0c0ac8d6b8d92;
    if (Blob && !Blob.prototype.stream) Blob.prototype.stream = function name(params) {
        ...
        return new ReadableStream({
            type: "bytes",
            async pull (ctrl) {
                const chunk = blob.slice(position, Math.min(blob.size, position + $8477fd97a532e712$var$POOL_SIZE));
                const buffer = await chunk.arrayBuffer();
                position += buffer.byteLength;
...
parcelRequire.register("d56GY", function(module, exports) {

$parcel$export(module.exports, "default", () => $9860eee680efb6d7$export$2e2bcd8739ae039);

var $dKr8m = parcelRequire("dKr8m");
const $9860eee680efb6d7$var$_File = class File extends (0, $dKr8m.default) {
    #lastModified = 0;
    #name = "";
    /**
   * @param {*[]} fileBits
   ...
   */ // @ts-ignore
    ...
    static [Symbol.hasInstance](object) {
        return !!object && object instanceof (0, $dKr8m.default) && /^(File)$/.test(object[Symbol.toStringTag]);
    }
};
const $9860eee680efb6d7$export$b6afa8811b7e644e = $9860eee680efb6d7$var$_File;
var $9860eee680efb6d7$export$2e2bcd8739ae039 = $9860eee680efb6d7$export$b6afa8811b7e644e;

});


parcelRequire.register("gJ5uW", function(module, exports) {
module.exports = Promise.resolve(require("./multipart-parser.162ac288.js")).then(()=>parcelRequire("aoV9q"));

});

parcelRequire.register("aWlRR", function(module, exports) {

$parcel$export(module.exports, "File", () => (parcelRequire("d56GY")).default);



var $6Jjly = parcelRequire("6Jjly");

var $d56GY = parcelRequire("d56GY");

var $dKr8m = parcelRequire("dKr8m");
const { stat: $7f7048a45d60b6fe$var$stat  } = (0, $IXXJW$nodefs.promises);
/**
 * @param {string} path filepath on the disk
 * @param {string} [type] mimetype to use
 */ const $7f7048a45d60b6fe$export$78b5aa82db01a2bc = (path, type)=>$7f7048a45d60b6fe$var$fromBlob((0, $IXXJW$nodefs.statSync)(path), path, type);
/**
 * @param {string} path filepath on the disk
 * @param {string} [type] mimetype to use
 * @returns {Promise<Blob>}
 */ const $7f7048a45d60b6fe$export$504fbde693c1771c = (path, type)=>$7f7048a45d60b6fe$var$stat(path).then((stat)=>$7f7048a45d60b6fe$var$fromBlob(stat, path, type));
/**
 * @param {string} path filepath on the disk
 * @param {string} [type] mimetype to use
 * @returns {Promise<File>}
 */ const $7f7048a45d60b6fe$export$c608e926fc97109f = (path, type)=>$7f7048a45d60b6fe$var$stat(path).then((stat)=>$7f7048a45d60b6fe$var$fromFile(stat, path, type));
/**
 * @param {string} path filepath on the disk
 * @param {string} [type] mimetype to use
 */ const $7f7048a45d60b6fe$export$bfe7c9da1baa5f76 = (path, type)=>$7f7048a45d60b6fe$var$fromFile((0, $IXXJW$nodefs.statSync)(path), path, type);
// @ts-ignore
const $7f7048a45d60b6fe$var$fromBlob = (stat, path, type = "")=>new (0, $dKr8m.default)([
        new $7f7048a45d60b6fe$var$BlobDataItem({
            path: path,
            size: stat.size,
...
// @ts-ignore
const $7f7048a45d60b6fe$var$fromFile = (stat, path, type = "")=>new (0, $d56GY.default)([
        new $7f7048a45d60b6fe$var$BlobDataItem({
            path: path,
            size: stat.size,
            lastModified: stat.mtimeMs,
    ...
    ], (0, $IXXJW$nodepath.basename)(path), {
        type: type,
        lastModified: stat.mtimeMs
    });
/**
 ...
 *
 * @private
 */ class $7f7048a45d60b6fe$var$BlobDataItem {
    #path;
    #start;
    constructor(options){
   ...
   */ slice(start, end) {
        return new $7f7048a45d60b6fe$var$BlobDataItem({
            path: this.#path,
    ...
    async *stream() {
        const { mtimeMs: mtimeMs  } = await $7f7048a45d60b6fe$var$stat(this.#path);
        if (mtimeMs > this.lastModified) throw new (0, (/*@__PURE__*/$parcel$interopDefault($6Jjly)))("The requested file could not be read, typically due to permission problems that have occurred after a reference to a file was acquired.", "NotReadableError");
        yield* (0, $IXXJW$nodefs.createReadStream)(this.#path, {
            start: this.#start,
...
var $7f7048a45d60b6fe$export$2e2bcd8739ae039 = $7f7048a45d60b6fe$export$78b5aa82db01a2bc;

});
parcelRequire.register("6Jjly", function(module, exports) {
/*! node-domexception. MIT License. Jimmy Wärting <https://jimmy.warting.se/opensource> */ 
if (!globalThis.DOMException) try {
    const { MessageChannel: MessageChannel  } = $4e65f3e15d20fa08$import$b63f432bf838ee78, port = new MessageChannel().port1, ab = new ArrayBuffer();
    port.postMessage(ab, [
        ab,
        ab
    ]);
 ...
 * @api public
 */ function $e98bac925ab59ba8$export$c16abeadb25f3229(uri) {
...
var $e98bac925ab59ba8$export$2e2bcd8739ae039 = $e98bac925ab59ba8$export$c16abeadb25f3229;
...
class $00c4d7e898751adf$export$359423e5a663266f extends Error {
...
class $4a2c24981ccd616f$export$26e841bcf1aeb894 extends (0, $00c4d7e898751adf$export$359423e5a663266f) {
    /**
 ...
 *
 * Object type checks.
 */ const $c7042a0f2732f910$var$NAME = Symbol.toStringTag;
const $c7042a0f2732f910$export$403f486803bfc6ff = (object)=>{
    return typeof object === "object" && typeof object.append === "function" && typeof object.delete === "function" && typeof object.get === "function" && typeof object.getAll === "function" && typeof object.has === "function" && typeof object.set === "function" && typeof object.sort === "function" && object[$c7042a0f2732f910$var$NAME] === "URLSearchParams";
};
const $c7042a0f2732f910$export$5bcd6e94ed871c88 = (object)=>{
    return object && typeof object === "object" && typeof object.arrayBuffer === "function" && typeof object.type === "string" && typeof object.stream === "function" && typeof object.constructor === "function" && /^(Blob|File)$/.test(object[$c7042a0f2732f910$var$NAME]);
};
const $c7042a0f2732f910$export$8fb8889db6ef9202 = (object)=>{
    return typeof object === "object" && (object[$c7042a0f2732f910$var$NAME] === "AbortSignal" || object[$c7042a0f2732f910$var$NAME] === "EventTarget");
};
const $c7042a0f2732f910$export$f0f20af6002339ab = (destination, original)=>{
    const orig = new URL(original).hostname;
    const dest = new URL(destination).hostname;
    return orig === dest || orig.endsWith(`.${dest}`);
};
const $c7042a0f2732f910$export$b756189618c5d1d5 = (destination, original)=>{
...
const $b4bf9572d66e1786$var$pipeline = (0, $IXXJW$nodeutil.promisify)((0, ($parcel$interopDefault($IXXJW$nodestream))).pipeline);
const $b4bf9572d66e1786$var$INTERNALS = Symbol("Body internals");

class $b4bf9572d66e1786$export$2e2bcd8739ae039 {
    constructor(body, { size: size = 0  } = {}){
        let boundary = null;
        if (body === null) // Body is undefined or null
        body = null;
        else if ((0, $c7042a0f2732f910$export$403f486803bfc6ff)(body)) // Body is a URLSearchParams
        body = (0, $IXXJW$nodebuffer.Buffer).from(body.toString());
        else if ((0, $c7042a0f2732f910$export$5bcd6e94ed871c88)(body)) ;
        else if ((0, $IXXJW$nodebuffer.Buffer).isBuffer(body)) ;
        else if ((0, $IXXJW$nodeutil.types).isAnyArrayBuffer(body)) // Body is ArrayBuffer
        body = (0, $IXXJW$nodebuffer.Buffer).from(body);
        else if (ArrayBuffer.isView(body)) // Body is ArrayBufferView
        body = (0, $IXXJW$nodebuffer.Buffer).from(body.buffer, body.byteOffset, body.byteLength);
        else if (body instanceof (0, ($parcel$interopDefault($IXXJW$nodestream)))) ;
        else if (body instanceof (0, $4ladG.FormData)) {
            // Body is FormData
            body = (0, $4ladG.formDataToBlob)(body);
            boundary = body.type.split("=")[1];
        } else // None of the above
        // coerce to string then buffer
        body = (0, $IXXJW$nodebuffer.Buffer).from(String(body));
        let stream = body;
        if ((0, $IXXJW$nodebuffer.Buffer).isBuffer(body)) stream = (0, ($parcel$interopDefault($IXXJW$nodestream))).Readable.from(body);
        else if ((0, $c7042a0f2732f910$export$5bcd6e94ed871c88)(body)) stream = (0, ($parcel$interopDefault($IXXJW$nodestream))).Readable.from(body.stream());
        this[$b4bf9572d66e1786$var$INTERNALS] = {
            body: body,
            stream: stream,
            boundary: boundary,
            disturbed: false,
        ...
        this.size = size;
        if (body instanceof (0, ($parcel$interopDefault($IXXJW$nodestream)))) body.on("error", (error_)=>{
            const error = error_ instanceof (0, $00c4d7e898751adf$export$359423e5a663266f) ? error_ : new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`Invalid response body while trying to fetch ${this.url}: ${error_.message}`, "system", error_);
            this[$b4bf9572d66e1786$var$INTERNALS].error = error;
        });
    }
    get body() {
        return this[$b4bf9572d66e1786$var$INTERNALS].stream;
    }
    get bodyUsed() {
        return this[$b4bf9572d66e1786$var$INTERNALS].disturbed;
    }
    /**
	 ...
	 * @return  Promise
	 */ async arrayBuffer() {
        const { buffer: buffer , byteOffset: byteOffset , byteLength: byteLength  } = await $b4bf9572d66e1786$var$consumeBody(this);
    ...
    async formData() {
        ...
        const { toFormData: toFormData  } = await (parcelRequire("gJ5uW"));
	 ...
	 * @return Promise
	 */ async blob() {
        const ct = this.headers && this.headers.get("content-type") || this[$b4bf9572d66e1786$var$INTERNALS].body && this[$b4bf9572d66e1786$var$INTERNALS].body.type || "";
        const buf = await this.arrayBuffer();
        return new (0, $dKr8m.default)([
            buf
        ], {
            type: ct
        });
	 ...
	 * @return  Promise
	 */ async text() {
        const buffer = await $b4bf9572d66e1786$var$consumeBody(this);
	 ...
	 * @return  Promise
	 */ buffer() {
        return $b4bf9572d66e1786$var$consumeBody(this);
    }
}
$b4bf9572d66e1786$export$2e2bcd8739ae039.prototype.buffer = (0, $IXXJW$nodeutil.deprecate)($b4bf9572d66e1786$export$2e2bcd8739ae039.prototype.buffer, "Please use 'response.arrayBuffer()' instead of 'response.buffer()'", "node-fetch#buffer");
// In browsers, all properties are enumerable.
Object.defineProperties($b4bf9572d66e1786$export$2e2bcd8739ae039.prototype, {
    body: {
        enumerable: true
    },
    bodyUsed: {
    ...
    data: {
        get: (0, $IXXJW$nodeutil.deprecate)(()=>{}, "data doesn't exist, use json(), text(), arrayBuffer(), or body instead", "https://github.com/node-fetch/node-fetch/issues/1000 (response)")
    }
});
/**
 ...
 *
 * @return Promise
 */ async function $b4bf9572d66e1786$var$consumeBody(data) {
    if (data[$b4bf9572d66e1786$var$INTERNALS].disturbed) throw new TypeError(`body used already for: ${data.url}`);
    data[$b4bf9572d66e1786$var$INTERNALS].disturbed = true;
    if (data[$b4bf9572d66e1786$var$INTERNALS].error) throw data[$b4bf9572d66e1786$var$INTERNALS].error;
    const { body: body  } = data;
    // Body is null
    if (body === null) return (0, $IXXJW$nodebuffer.Buffer).alloc(0);
    /* c8 ignore next 3 */ if (!(body instanceof (0, ($parcel$interopDefault($IXXJW$nodestream))))) return (0, $IXXJW$nodebuffer.Buffer).alloc(0);
    // Body is stream
    ...
    try {
        for await (const chunk of body){
            if (data.size > 0 && accumBytes + chunk.length > data.size) {
                const error = new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`content size at ${data.url} over limit: ${data.size}`, "max-size");
                body.destroy(error);
                throw error;
            }
        ...
        const error_ = error instanceof (0, $00c4d7e898751adf$export$359423e5a663266f) ? error : new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`Invalid response body while trying to fetch ${data.url}: ${error.message}`, "system", error);
        throw error_;
    }
    if (body.readableEnded === true || body._readableState.ended === true) try {
        if (accum.every((c)=>typeof c === "string")) return (0, $IXXJW$nodebuffer.Buffer).from(accum.join(""));
        return (0, $IXXJW$nodebuffer.Buffer).concat(accum, accumBytes);
    } catch (error) {
        throw new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`Could not create Buffer from response body for ${data.url}: ${error.message}`, "system", error);
    }
    else throw new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`Premature close of server response while trying to fetch ${data.url}`);
}
const $b4bf9572d66e1786$export$9cd59f9826255e47 = (instance, highWaterMark)=>{
    let p1;
    let p2;
    let { body: body  } = instance[$b4bf9572d66e1786$var$INTERNALS];
    // Don't allow cloning a used body
    if (instance.bodyUsed) throw new Error("cannot clone body after it is used");
    // Check that body is a stream and not form-data object
    // note: we can't clone the form-data object without having it as a dependency
    if (body instanceof (0, ($parcel$interopDefault($IXXJW$nodestream))) && typeof body.getBoundary !== "function") {
        // Tee instance body
        p1 = new (0, $IXXJW$nodestream.PassThrough)({
            highWaterMark: highWaterMark
        });
        p2 = new (0, $IXXJW$nodestream.PassThrough)({
            highWaterMark: highWaterMark
        });
        body.pipe(p1);
        body.pipe(p2);
        // Set instance body to teed body and return the other teed body
        instance[$b4bf9572d66e1786$var$INTERNALS].stream = p1;
        body = p2;
    }
    return body;
};
const $b4bf9572d66e1786$var$getNonSpecFormDataBoundary = (0, $IXXJW$nodeutil.deprecate)((body)=>body.getBoundary(), "form-data doesn't follow the spec and requires special treatment. Use alternative package", "https://github.com/node-fetch/node-fetch/issues/1167");
const $b4bf9572d66e1786$export$2b9b51eb2e7a33e6 = (body, request)=>{
    // Body is null or undefined
    if (body === null) return null;
    // Body is string
    if (typeof body === "string") return "text/plain;charset=UTF-8";
    // Body is a URLSearchParams
    if ((0, $c7042a0f2732f910$export$403f486803bfc6ff)(body)) return "application/x-www-form-urlencoded;charset=UTF-8";
    // Body is blob
    if ((0, $c7042a0f2732f910$export$5bcd6e94ed871c88)(body)) return body.type || null;
    // Body is a Buffer (Buffer, ArrayBuffer or ArrayBufferView)
    if ((0, $IXXJW$nodebuffer.Buffer).isBuffer(body) || (0, $IXXJW$nodeutil.types).isAnyArrayBuffer(body) || ArrayBuffer.isView(body)) return null;
    if (body instanceof (0, $4ladG.FormData)) return `multipart/form-data; boundary=${request[$b4bf9572d66e1786$var$INTERNALS].boundary}`;
    // Detect form data input from form-data module
    if (body && typeof body.getBoundary === "function") return `multipart/form-data;boundary=${$b4bf9572d66e1786$var$getNonSpecFormDataBoundary(body)}`;
    // Body is stream - can't really do much about this
    if (body instanceof (0, ($parcel$interopDefault($IXXJW$nodestream)))) return null;
    // Body constructor defaults other things to string
    return "text/plain;charset=UTF-8";
};
const $b4bf9572d66e1786$export$6ea4452c6ae2956f = (request)=>{
    const { body: body  } = request[$b4bf9572d66e1786$var$INTERNALS];
    // Body is null or undefined
    if (body === null) return 0;
    // Body is Blob
    if ((0, $c7042a0f2732f910$export$5bcd6e94ed871c88)(body)) return body.size;
    // Body is Buffer
    if ((0, $IXXJW$nodebuffer.Buffer).isBuffer(body)) return body.length;
    // Detect form data input from form-data module
    if (body && typeof body.getLengthSync === "function") return body.hasKnownLength && body.hasKnownLength() ? body.getLengthSync() : null;
    // Body is stream
    return null;
};
const $b4bf9572d66e1786$export$df92035d47a0b6a3 = async (dest, { body: body  })=>{
    if (body === null) // Body is null
    dest.end();
    else // Body is stream
    await $b4bf9572d66e1786$var$pipeline(body, dest);
};
...
/* c8 ignore next 9 */ const $fcb3b1b3fb15bb0e$var$validateHeaderName = typeof (0, ($parcel$interopDefault($IXXJW$nodehttp))).validateHeaderName === "function" ? (0, ($parcel$interopDefault($IXXJW$nodehttp))).validateHeaderName : (name)=>{
    if (!/^[\^`\-\w!#$%&'*+.|~]+$/.test(name)) {
...
/* c8 ignore next 9 */ const $fcb3b1b3fb15bb0e$var$validateHeaderValue = typeof (0, ($parcel$interopDefault($IXXJW$nodehttp))).validateHeaderValue === "function" ? (0, ($parcel$interopDefault($IXXJW$nodehttp))).validateHeaderValue : (name, value)=>{
    if (/[^\t\u0020-\u007E\u0080-\u00FF]/.test(value)) {
...
class $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039 extends URLSearchParams {
    /**
	 * Headers class
	 *
	 * @constructor
	 ...
	 */ constructor(init){
        ...
        if (init instanceof $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039) {
            const raw = init.raw();
        ...
        else if (typeof init === "object" && !(0, $IXXJW$nodeutil.types).isBoxedPrimitive(init)) {
            ...
            result.push(...Object.entries(init));
                ...
                result = [
                    ...
                    if (typeof pair !== "object" || (0, $IXXJW$nodeutil.types).isBoxedPrimitive(pair)) throw new TypeError("Each header pair must be an iterable object");
                    return [
                        ...pair
                    ];
                }).map((pair)=>{
        ...
        result = result.length > 0 ? result.map(([name, value])=>{
            $fcb3b1b3fb15bb0e$var$validateHeaderName(name);
            $fcb3b1b3fb15bb0e$var$validateHeaderValue(name, String(value));
            return [
 ...
 */ Object.defineProperties($fcb3b1b3fb15bb0e$export$2e2bcd8739ae039.prototype, [
    "get",
    "entries",
    "forEach",
    "values"
...
function $fcb3b1b3fb15bb0e$export$8c3dd7dbe8ad5e3e(headers = []) {
    return new $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039(headers// Split into pairs
...
const $67a4567354290c76$var$redirectStatus = new Set([
    301,
    302,
    303,
    307,
...
const $67a4567354290c76$export$4cb830d4f7e56898 = (code)=>{
    return $67a4567354290c76$var$redirectStatus.has(code);
};


const $5b0ecbc8f4fe995d$var$INTERNALS = Symbol("Response internals");
class $5b0ecbc8f4fe995d$export$2e2bcd8739ae039 extends (0, $b4bf9572d66e1786$export$2e2bcd8739ae039) {
    constructor(body = null, options = {}){
        super(body, options);
        // eslint-disable-next-line no-eq-null, eqeqeq, no-negated-condition
        const status = options.status != null ? options.status : 200;
        const headers = new (0, $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039)(options.headers);
        if (body !== null && !headers.has("Content-Type")) {
            const contentType = (0, $b4bf9572d66e1786$export$2b9b51eb2e7a33e6)(body, this);
            if (contentType) headers.append("Content-Type", contentType);
        }
        this[$5b0ecbc8f4fe995d$var$INTERNALS] = {
            type: "default",
            url: options.url,
            status: status,
    ...
    get type() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].type;
    }
    get url() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].url || "";
    }
    get status() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].status;
    }
    /**
	 * Convenience property representing if the request ended normally
	 */ get ok() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].status >= 200 && this[$5b0ecbc8f4fe995d$var$INTERNALS].status < 300;
    }
    get redirected() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].counter > 0;
    }
    get statusText() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].statusText;
    }
    get headers() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].headers;
    }
    get highWaterMark() {
        return this[$5b0ecbc8f4fe995d$var$INTERNALS].highWaterMark;
    }
    /**
	 * Clone this response
	 *
	 * @return  Response
	 */ clone() {
        return new $5b0ecbc8f4fe995d$export$2e2bcd8739ae039((0, $b4bf9572d66e1786$export$9cd59f9826255e47)(this, this.highWaterMark), {
            type: this.type,
            url: this.url,
            status: this.status,
	 ...
	 */ static redirect(url, status = 302) {
        if (!(0, $67a4567354290c76$export$4cb830d4f7e56898)(status)) throw new RangeError('Failed to execute "redirect" on "response": Invalid status code');
        return new $5b0ecbc8f4fe995d$export$2e2bcd8739ae039(null, {
            headers: {
    ...
    static error() {
        const response = new $5b0ecbc8f4fe995d$export$2e2bcd8739ae039(null, {
            status: 0,
            statusText: ""
        });
        response[$5b0ecbc8f4fe995d$var$INTERNALS].type = "error";
        return response;
    }
    static json(data, init = {}) {
        const body = JSON.stringify(data);
        if (body === undefined) throw new TypeError("data is not JSON serializable");
        const headers = new (0, $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039)(init && init.headers);
        if (!headers.has("content-type")) headers.set("content-type", "application/json");
        return new $5b0ecbc8f4fe995d$export$2e2bcd8739ae039(body, {
            ...init,
            headers: headers
        });
    }
...
Object.defineProperties($5b0ecbc8f4fe995d$export$2e2bcd8739ae039.prototype, {
    type: {
        enumerable: true
    },
    url: {
...
const $23eff1f77e5e120e$export$786f9a4bc80cc6b0 = (parsedURL)=>{
...
function $1fdb98baabfc8c22$export$fde0b49925f91fce(url, originOnly = false) {
...
const $1fdb98baabfc8c22$export$64a0787db794a809 = new Set([
    "",
    "no-referrer",
...
const $1fdb98baabfc8c22$export$69cb217583b60dbe = "strict-origin-when-cross-origin";
function $1fdb98baabfc8c22$export$840c90fd8051a475(referrerPolicy) {
    if (!$1fdb98baabfc8c22$export$64a0787db794a809.has(referrerPolicy)) throw new TypeError(`Invalid referrerPolicy: ${referrerPolicy}`);
    return referrerPolicy;
}
function $1fdb98baabfc8c22$export$6499a3a808b93780(url) {
    ...
    const hostIPVersion = (0, $IXXJW$nodenet.isIP)(hostIp);
...
function $1fdb98baabfc8c22$export$120341f873018e7b(url) {
    ...
    return $1fdb98baabfc8c22$export$6499a3a808b93780(url);
}
function $1fdb98baabfc8c22$export$d13d6247dda1a179(request, { referrerURLCallback: referrerURLCallback , referrerOriginCallback: referrerOriginCallback  } = {}) {
    ...
    let referrerURL = $1fdb98baabfc8c22$export$fde0b49925f91fce(referrerSource);
    // 5. Let referrerOrigin be the result of stripping referrerSource for use as a referrer, with the
    //    origin-only flag set to true.
    let referrerOrigin = $1fdb98baabfc8c22$export$fde0b49925f91fce(referrerSource, true);
    ...
    switch(policy){
        ...
        case "strict-origin":
            ...
            if ($1fdb98baabfc8c22$export$120341f873018e7b(referrerURL) && !$1fdb98baabfc8c22$export$120341f873018e7b(currentURL)) return "no-referrer";
...
function $1fdb98baabfc8c22$export$761ed3bd86bd3c9(headers) {
    ...
    for (const token of policyTokens)if (token && $1fdb98baabfc8c22$export$64a0787db794a809.has(token)) policy = token;
    // 4. Return policy.
    return policy;
}


const $f618d559086ce37e$var$INTERNALS = Symbol("Request internals");
/**
 * Check if `obj` is an instance of Request.
 *
 * @param  {*} object
 * @return {boolean}
 */ const $f618d559086ce37e$var$isRequest = (object)=>{
    return typeof object === "object" && typeof object[$f618d559086ce37e$var$INTERNALS] === "object";
};
const $f618d559086ce37e$var$doBadDataWarn = (0, $IXXJW$nodeutil.deprecate)(()=>{}, ".data is not a valid RequestInit property, use .body instead", "https://github.com/node-fetch/node-fetch/issues/1000 (request)");
class $f618d559086ce37e$export$2e2bcd8739ae039 extends (0, $b4bf9572d66e1786$export$2e2bcd8739ae039) {
    constructor(input, init = {}){
        let parsedURL;
        // Normalize input and force URL to be encoded as UTF-8 (https://github.com/node-fetch/node-fetch/issues/245)
        if ($f618d559086ce37e$var$isRequest(input)) parsedURL = new URL(input.url);
        else {
        ...
        if (!$f618d559086ce37e$var$isRequest(init) && "data" in init) $f618d559086ce37e$var$doBadDataWarn();
        // eslint-disable-next-line no-eq-null, eqeqeq
        if ((init.body != null || $f618d559086ce37e$var$isRequest(input) && input.body !== null) && (method === "GET" || method === "HEAD")) throw new TypeError("Request with GET/HEAD method cannot have body");
        const inputBody = init.body ? init.body : $f618d559086ce37e$var$isRequest(input) && input.body !== null ? (0, $b4bf9572d66e1786$export$9cd59f9826255e47)(input) : null;
        super(inputBody, {
            size: init.size || input.size || 0
        });
        const headers = new (0, $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039)(init.headers || input.headers || {});
        if (inputBody !== null && !headers.has("Content-Type")) {
            const contentType = (0, $b4bf9572d66e1786$export$2b9b51eb2e7a33e6)(inputBody, this);
            if (contentType) headers.set("Content-Type", contentType);
        }
        let signal = $f618d559086ce37e$var$isRequest(input) ? input.signal : null;
        if ("signal" in init) signal = init.signal;
        // eslint-disable-next-line no-eq-null, eqeqeq
        if (signal != null && !(0, $c7042a0f2732f910$export$8fb8889db6ef9202)(signal)) throw new TypeError("Expected signal to be an instanceof AbortSignal or EventTarget");
        ...
        this[$f618d559086ce37e$var$INTERNALS] = {
            method: method,
    ...
    /** @returns {string} */ get method() {
        return this[$f618d559086ce37e$var$INTERNALS].method;
    }
    /** @returns {string} */ get url() {
        return (0, $IXXJW$nodeurl.format)(this[$f618d559086ce37e$var$INTERNALS].parsedURL);
    }
    /** @returns {Headers} */ get headers() {
        return this[$f618d559086ce37e$var$INTERNALS].headers;
    }
    get redirect() {
        return this[$f618d559086ce37e$var$INTERNALS].redirect;
    }
    /** @returns {AbortSignal} */ get signal() {
        return this[$f618d559086ce37e$var$INTERNALS].signal;
    }
    // https://fetch.spec.whatwg.org/#dom-request-referrer
    get referrer() {
        if (this[$f618d559086ce37e$var$INTERNALS].referrer === "no-referrer") return "";
        if (this[$f618d559086ce37e$var$INTERNALS].referrer === "client") return "about:client";
        if (this[$f618d559086ce37e$var$INTERNALS].referrer) return this[$f618d559086ce37e$var$INTERNALS].referrer.toString();
        return undefined;
    }
    get referrerPolicy() {
        return this[$f618d559086ce37e$var$INTERNALS].referrerPolicy;
    }
    set referrerPolicy(referrerPolicy) {
        this[$f618d559086ce37e$var$INTERNALS].referrerPolicy = (0, $1fdb98baabfc8c22$export$840c90fd8051a475)(referrerPolicy);
    }
    /**
	 * Clone this request
	 *
	 * @return  Request
	 */ clone() {
        return new $f618d559086ce37e$export$2e2bcd8739ae039(this);
    }
    get [Symbol.toStringTag]() {
        return "Request";
    }
}
Object.defineProperties($f618d559086ce37e$export$2e2bcd8739ae039.prototype, {
    method: {
        enumerable: true
    },
    url: {
...
const $f618d559086ce37e$export$a9a3332d4dbf466c = (request)=>{
    const { parsedURL: parsedURL  } = request[$f618d559086ce37e$var$INTERNALS];
    const headers = new (0, $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039)(request[$f618d559086ce37e$var$INTERNALS].headers);
    // Fetch step 1.3
    ...
    if (request.body !== null) {
        const totalBytes = (0, $b4bf9572d66e1786$export$6ea4452c6ae2956f)(request);
    ...
    if (request.referrerPolicy === "") request.referrerPolicy = (0, $1fdb98baabfc8c22$export$69cb217583b60dbe);
    // 4.1. Main fetch, step 2.7
    // > If request's referrer is not "no-referrer", set request's referrer to the result of invoking
    // > determine request's referrer.
    if (request.referrer && request.referrer !== "no-referrer") request[$f618d559086ce37e$var$INTERNALS].referrer = (0, $1fdb98baabfc8c22$export$d13d6247dda1a179)(request);
    else request[$f618d559086ce37e$var$INTERNALS].referrer = "no-referrer";
    // 4.5. HTTP-network-or-cache fetch, step 6.9
    // > If httpRequest's referrer is a URL, then append `Referer`/httpRequest's referrer, serialized
    // >  and isomorphic encoded, to httpRequest's header list.
    if (request[$f618d559086ce37e$var$INTERNALS].referrer instanceof URL) headers.set("Referer", request.referrer);
    ...
    const search = (0, $23eff1f77e5e120e$export$786f9a4bc80cc6b0)(parsedURL);
...
class $3b93dc334b0edf80$export$18b052ffd8c84d7 extends (0, $00c4d7e898751adf$export$359423e5a663266f) {
...
const $40f9cb52622e3ba0$var$supportedSchemas = new Set([
    "data:",
    "http:",
    "https:"
]);
async function $40f9cb52622e3ba0$export$2e2bcd8739ae039(url, options_) {
    return new Promise((resolve, reject)=>{
        // Build request object
        const request = new (0, $f618d559086ce37e$export$2e2bcd8739ae039)(url, options_);
        const { parsedURL: parsedURL , options: options  } = (0, $f618d559086ce37e$export$a9a3332d4dbf466c)(request);
        if (!$40f9cb52622e3ba0$var$supportedSchemas.has(parsedURL.protocol)) throw new TypeError(`node-fetch cannot load ${url}. URL scheme "${parsedURL.protocol.replace(/:$/, "")}" is not supported.`);
        if (parsedURL.protocol === "data:") {
            const data = (0, $e98bac925ab59ba8$export$2e2bcd8739ae039)(request.url);
            const response = new (0, $5b0ecbc8f4fe995d$export$2e2bcd8739ae039)(data, {
                headers: {
        ...
        const send = (parsedURL.protocol === "https:" ? (0, ($parcel$interopDefault($IXXJW$nodehttps))) : (0, ($parcel$interopDefault($IXXJW$nodehttp)))).request;
        const { signal: signal  } = request;
        let response = null;
        const abort = ()=>{
            const error = new (0, $3b93dc334b0edf80$export$18b052ffd8c84d7)("The operation was aborted.");
            reject(error);
            if (request.body && request.body instanceof (0, ($parcel$interopDefault($IXXJW$nodestream))).Readable) request.body.destroy(error);
        ...
        request_.on("error", (error)=>{
            reject(new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`request to ${request.url} failed, reason: ${error.message}`, "system", error));
            finalize();
        });
        $40f9cb52622e3ba0$var$fixResponseChunkedTransferBadEnding(request_, (error)=>{
        ...
        request_.on("response", (response_)=>{
            ...
            const headers = (0, $fcb3b1b3fb15bb0e$export$8c3dd7dbe8ad5e3e)(response_.rawHeaders);
            // HTTP fetch step 5
            if ((0, $67a4567354290c76$export$4cb830d4f7e56898)(response_.statusCode)) {
                // HTTP fetch step 5.2
                ...
                try {
                    ...
                    if (request.redirect !== "manual") {
                        reject(new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`uri requested responds with an invalid redirect URL: ${location}`, "invalid-redirect"));
                        finalize();
                        return;
                    }
                }
                ...
                switch(request.redirect){
                    case "error":
                        reject(new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`uri requested responds with a redirect, redirect mode is set to error: ${request.url}`, "no-redirect"));
                        finalize();
                        return;
                    case "manual":
                        break;
                    case "follow":
                        {
                            ...
                            if (request.counter >= request.follow) {
                                reject(new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)(`maximum redirect reached at: ${request.url}`, "max-redirect"));
                                finalize();
                                return;
                            }
                            ...
                            const requestOptions = {
                                headers: new (0, $fcb3b1b3fb15bb0e$export$2e2bcd8739ae039)(request.headers),
                                follow: request.follow,
                                counter: request.counter + 1,
                                agent: request.agent,
                                compress: request.compress,
                                method: request.method,
                                body: (0, $b4bf9572d66e1786$export$9cd59f9826255e47)(request),
                            ...
                            if (!(0, $c7042a0f2732f910$export$f0f20af6002339ab)(request.url, locationURL) || !(0, $c7042a0f2732f910$export$b756189618c5d1d5)(request.url, locationURL)) for (const name of [
                                "authorization",
                                "www-authenticate",
                                "cookie",
                                "cookie2"
                            ...
                            if (response_.statusCode !== 303 && request.body && options_.body instanceof (0, ($parcel$interopDefault($IXXJW$nodestream))).Readable) {
                                reject(new (0, $4a2c24981ccd616f$export$26e841bcf1aeb894)("Cannot follow redirect with body being a readable stream", "unsupported-redirect"));
                                finalize();
                                return;
                            }
                            ...
                            const responseReferrerPolicy = (0, $1fdb98baabfc8c22$export$761ed3bd86bd3c9)(headers);
                            if (responseReferrerPolicy) requestOptions.referrerPolicy = responseReferrerPolicy;
                            // HTTP-redirect fetch step 15
                            resolve($40f9cb52622e3ba0$export$2e2bcd8739ae039(new (0, $f618d559086ce37e$export$2e2bcd8739ae039)(locationURL, requestOptions)));
                            finalize();
                            return;
                        }
                    default:
            ...
            let body = (0, $IXXJW$nodestream.pipeline)(response_, new (0, $IXXJW$nodestream.PassThrough)(), (error)=>{
            ...
            if (!request.compress || request.method === "HEAD" || codings === null || response_.statusCode === 204 || response_.statusCode === 304) {
                response = new (0, $5b0ecbc8f4fe995d$export$2e2bcd8739ae039)(body, responseOptions);
                resolve(response);
                return;
            }
            // For Node v6+
            ...
            const zlibOptions = {
                flush: (0, ($parcel$interopDefault($IXXJW$nodezlib))).Z_SYNC_FLUSH,
                finishFlush: (0, ($parcel$interopDefault($IXXJW$nodezlib))).Z_SYNC_FLUSH
            };
            // For gzip
            if (codings === "gzip" || codings === "x-gzip") {
                body = (0, $IXXJW$nodestream.pipeline)(body, (0, ($parcel$interopDefault($IXXJW$nodezlib))).createGunzip(zlibOptions), (error)=>{
                    if (error) reject(error);
                });
                response = new (0, $5b0ecbc8f4fe995d$export$2e2bcd8739ae039)(body, responseOptions);
                resolve(response);
            ...
            if (codings === "deflate" || codings === "x-deflate") {
                ...
                const raw = (0, $IXXJW$nodestream.pipeline)(response_, new (0, $IXXJW$nodestream.PassThrough)(), (error)=>{
                    if (error) reject(error);
                });
                raw.once("data", (chunk)=>{
                    // See http://stackoverflow.com/questions/37519828
                    if ((chunk[0] & 0x0F) === 0x08) body = (0, $IXXJW$nodestream.pipeline)(body, (0, ($parcel$interopDefault($IXXJW$nodezlib))).createInflate(), (error)=>{
                        if (error) reject(error);
                    });
                    else body = (0, $IXXJW$nodestream.pipeline)(body, (0, ($parcel$interopDefault($IXXJW$nodezlib))).createInflateRaw(), (error)=>{
                        if (error) reject(error);
                    });
                    response = new (0, $5b0ecbc8f4fe995d$export$2e2bcd8739ae039)(body, responseOptions);
                    resolve(response);
            ...
            // For br
            if (codings === "br") {
                body = (0, $IXXJW$nodestream.pipeline)(body, (0, ($parcel$interopDefault($IXXJW$nodezlib))).createBrotliDecompress(), (error)=>{
                    if (error) reject(error);
                });
                response = new (0, $5b0ecbc8f4fe995d$export$2e2bcd8739ae039)(body, responseOptions);
                resolve(response);
        ...
        (0, $b4bf9572d66e1786$export$df92035d47a0b6a3)(request_, request).catch(reject);
    });
}
function $40f9cb52622e3ba0$var$fixResponseChunkedTransferBadEnding(request, errorCallback) {
    const LAST_CHUNK = (0, $IXXJW$nodebuffer.Buffer).from("0\r\n\r\n");
    ...
    request.on("socket", (socket)=>{
        ...
        const onData = (buf)=>{
            properLastChunkReceived = (0, $IXXJW$nodebuffer.Buffer).compare(buf.slice(-5), LAST_CHUNK) === 0;
            // Sometimes final 0-length chunk and end of message code are in separate packets
            if (!properLastChunkReceived && previousChunk) properLastChunkReceived = (0, $IXXJW$nodebuffer.Buffer).compare(previousChunk.slice(-3), LAST_CHUNK.slice(0, 3)) === 0 && (0, $IXXJW$nodebuffer.Buffer).compare(buf.slice(-2), LAST_CHUNK.slice(3)) === 0;
            previousChunk = buf;
        };
...
class $1ad517f6efcdb4ef$export$3bbcb4831e58d00d {
    ...
    async getCpData(cp) {
        const ciudad = await (0, $40f9cb52622e3ba0$export$2e2bcd8739ae039)(`https://acromatico-cp.uc.r.appspot.com/api/cp/${cp}`, {
            headers: {
